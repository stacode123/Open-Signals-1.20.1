...
public final class LogicParser {
    ...
    static {
        TRANSLATION_TABLE.put("with", new MethodInfo(ModelData.class, "with",
                objects -> PredicateHolder.with((ValuePack) objects[0]), ValuePack.class));

        TRANSLATION_TABLE.put("has", new MethodInfo(ModelData.class, "has",
                objects -> PredicateHolder.has((SEProperty) objects[0]), SEProperty.class));

        TRANSLATION_TABLE.put("hasandis", new MethodInfo(ModelData.class, "hasandis",
                objects -> PredicateHolder.hasAndIs((SEProperty) objects[0]), SEProperty.class));

        TRANSLATION_TABLE.put("hasandisnot", new MethodInfo(ModelData.class, "hasandisnot",
